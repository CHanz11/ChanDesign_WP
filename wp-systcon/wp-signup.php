...
require ABSPATH . 'wp-systcon/wp-load.php';

add_filter( 'wp_robots', 'wp_robots_no_robots' );

require ABSPATH . 'wp-systcon/wp-blog-header.php';
...
function confirm_another_blog_signup( $domain, $path, $blog_title, $user_name, $user_email = '', $meta = array(), $blog_id = 0 ) {
	...
	if ( $blog_id ) {
		...
		$login_url = 'http://' . $domain . $path . WPLOGIN_KEYWORD .'.php';
	}
...
function signup_blog( $user_name = '', $user_email = '', $blogname = '', $blog_title = '', $errors = '' ) {
    ...
    <form id="setupform" method="post" action="wp-signup.php">
      ...
      <?php
		...
		?>
      <?php show_blog_form( $blogname, $blog_title, $errors ); ?>
      <p class="submit"><input type="submit" name="submit" class="submit" value="<?php esc_attr_e( 'Sign up' ); ?>" />
      </p>
    </form>
    <?php
}
