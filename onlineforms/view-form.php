...
<body class="hold-transition">
    <div class="login-box">
        ...
        //     <h1 style='font: 16px new times roman; color:#180087; font-weight:bold;'>" . $db->form_subject . "</h1>
        //     <span style='font: 16px new times roman; font-weight:bold;'>" . $db->form_from . "</span>
        //     <small style='font: 16px new times roman; font-weight:bold;'>" . $date->format("F d, Y") . " at " . $date->format("g:i A") . "</small>
...
<script>
    $(document).on('click', '#printform', function (e) {
        ...
        const data = `<?= $response['print_subject'] . "<div style='font: 14px Open Sans,sans-serif;'>" . $response['form_details'] . "</div>" ?>`;
