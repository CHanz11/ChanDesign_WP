...
$formname = 'Initial Free Consultation Form';
...
<body>
							...
							<div class="form_box">
								...
								<div class="form_box">
									<div class="form_box_col1">
										<div class="group">
											<?php
											// @param label-name, if required
											$input->label('Do you own an LLC?');
											// @param field name, class, id and attribute
											$input->radio('Do_you_own_an_LLC', array('Yes', 'No'), 'Do_you_own_an_LLC', '', '2');
											?>
										</div>
									</div>
								</div>
								...
								<div class="form_box" id="ifyes1">
									<div class="form_box_col1">
										<div class="group">
											<?php
											// @param label-name, if required
											$input->label('What business do you which to open?');
											// @param field name, class, id and attribute
											$input->textarea('What_business_do_you_which_to_open', 'text form_field', 'What_business_do_you_which_to_open', 'placeholder="Enter details here"');
											?>
										</div>
									</div>
								</div>
								...
								<div class="form_box">
									<div class="form_box_col2">
										...
										<?php
											// @param label-name, if required
											$input->label('Do you need Licensure?');
											// @param field name, class, id and attribute
											$input->radio('Do_you_need_Licensure', array('Yes', 'No'), 'Do_you_need_Licensure', '', '2');
											?>
										...
										<?php
											// @param label-name, if required
											$input->label('Do you need Accreditation?');
											// @param field name, class, id and attribute
											$input->radio('Do_you_need_Accreditation', array('Yes', 'No'), 'Do_you_need_Accreditation', '', '2');
											?>
								...
								<div class="form_box">
									<div class="form_box_col2">
										...
										<?php
											// @param label-name, if required
											$input->label('Do you need software training?');
											// @param field name, class, id and attribute
											$input->radio('Do_you_need_software_training', array('Yes', 'No'), 'Do_you_need_software_training', '', '2');
											?>
										...
										<?php
											// @param label-name, if required
											$input->label('Do you need HR training?');
											// @param field name, class, id and attribute
											$input->radio('Do_you_need_HR_training', array('Yes', 'No'), 'Do_you_need_HR_training', '', '2');
											?>
								...
								<div class="form_box">
									<div class="form_box_col2">
										...
										<?php
											// @param label-name, if required
											$input->label('Do you need OAISIS training?');
											// @param field name, class, id and attribute
											$input->radio('Do_you_need_OAISIS_training', array('Yes', 'No'), 'Do_you_need_OAISIS_training', '', '2');
											?>
										...
										<?php
											// @param label-name, if required
											$input->label('Do need case management training?');
											// @param field name, class, id and attribute
											$input->radio('Do_need_case_management_training', array('Yes', 'No'), 'Do_need_case_management_training', '', '2');
											?>
								...
								<div class="form_box">
									<div class="form_box_col2">
										...
										<?php
											// @param label-name, if required
											$input->label('Do you need to get ready for your initial survey?');
											// @param field name, class, id and attribute
											$input->radio('Do_you_need_to_get_ready_for_your_initial_survey', array('Yes', 'No'), 'Do_you_need_to_get_ready_for_your_initial_survey', '', '2');
											?>
										...
										<?php
											// @param label-name, if required
											$input->label('Do you need Re-Accrediatation?');
											// @param field name, class, id and attribute
											$input->radio('Do_you_need_Re_Accrediatation', array('Yes', 'No'), 'Do_you_need_Re_Accrediatation', '', '2');
											?>
								...
								<div class="form_box">
									<div class="form_box_col1">
										<div class="group">
											<?php
											// @param label-name, if required
											$input->label('Do you need Insurance Credentialing?');
											// @param field name, class, id and attribute
											$input->radio('Do_you_need_Insurance_Credentialing', array('Yes', 'No'), 'Do_you_need_Insurance_Credentialing', '', '2');
											?>
										</div>
									</div>
								</div>
								...
								<div class="form_box" id="ifyes2">
									<div class="form_box_col1">
										<div class="group">
											<?php
											// @param label-name, if required
											$input->label('What is the insurance company?');
											// @param field name, class, id and attribute
											$input->textarea('What_is_the_insurance_company', 'text form_field', 'What_is_the_insurance_company', 'placeholder="Enter details here"');
											?>
										</div>
									</div>
								</div>
								...
								<div class="disclaimer" style="margin-left: 5px;">
	...
	<script type="text/javascript">
		$(document).ready(function () {
			...
			/* radio toggle */
			$("input[name='Do_you_own_an_LLC']").change(function () {
				if ($(this).val() == "Yes") {
					$("#ifyes1").fadeIn();
			...
			/* radio toggle */
			$("input[name='Do_you_need_Insurance_Credentialing']").change(function () {
				if ($(this).val() == "Yes") {
					$("#ifyes2").fadeIn();
