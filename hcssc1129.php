...
<body class="login no-js <?php echo esc_attr( implode( ' ', $classes ) ); ?>">
  ...
  <?php
	...
	?>
  <div id="login">
    <div style="padding: 10px; text-align:center;background:#fff; border-radius:8px;"><a
        style="display:block; box-shadow: none;" href="<?php echo get_home_url(); ?>"><img
          src="<?php bloginfo('template_url'); ?>/images/main-logo.png" alt="<?php echo get_bloginfo('name');?>"
...
<form class="admin-email-confirm-form" name="admin-email-confirm-form"
  action="<?php echo esc_url( site_url(WPLOGIN_KEYWORD . '.php?action=confirm_admin_email', 'login_post' ) ); ?>"
  method="post">
  <?php
			/**
...
<form name="lostpasswordform" id="lostpasswordform"
  action="<?php echo esc_url( network_site_url( WPLOGIN_KEYWORD .'.php?action=lostpassword', 'login_post' ) ); ?>"
  method="post">
  <p>
...
<form name="resetpassform" id="resetpassform"
  action="<?php echo esc_url( network_site_url( WPLOGIN_KEYWORD .'.php?action=resetpass', 'login_post' ) ); ?>"
...
<form name="registerform" id="registerform"
  action="<?php echo esc_url( site_url( WPLOGIN_KEYWORD .'.php?action=register', 'login_post' ) ); ?>" method="post"
  ...
  <p>
    ...
    <input type="email" name="user_email" id="user_email" class="input"
      value="<?php echo esc_attr( wp_unslash( $user_email ) ); ?>" size="25" autocomplete="email" required="required" />
  </p>
  <?php
...
<p id="nav">
  ...
  <?php
			...
			$html_link = sprintf( '<a class="wp-login-lost-password" href="%s">%s</a>', esc_url( site_url( WPLOGIN_KEYWORD) . '.php?action=lostpassword' ), __( 'Lost your password?' ) );
...
<form name="loginform" id="loginform"
  action="<?php echo esc_url( site_url( WPLOGIN_KEYWORD .'.php', 'login_post' ) ); ?>" method="post">
  <p>
    <label for="user_login"><?php _e( 'Username or Email Address' ); ?></label>
  ...
  <p class="forgetmenot"><input name="rememberme" type="checkbox" id="rememberme" value="forever"
      <?php checked( $rememberme ); ?> /> <label for="rememberme"><?php esc_html_e( 'Remember Me' ); ?></label></p>
  <p class="submit">
    <input type="submit" name="wp-submit" id="wp-submit" class="button button-primary button-large"
